...
export default {
    ...
    async execute(objMessage, args, userPhone, groupId) {
        ...
        const commandsList = [
            ...
            '!trocar *nome do jogador* - Inicia uma troca com outro jogador.',
            '!adicionar *pokemon ou moedas* - Adiciona um pokemon ou moedas à troca.',
            '!remover *pokemon ou moedas* - Remove uma oferta da troca.',
            '!finalizar - Finaliza a troca atual.',
